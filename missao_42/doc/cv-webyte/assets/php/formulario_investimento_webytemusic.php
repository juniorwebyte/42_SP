...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $subject = "Investimento - webytemusic.com";
...
<head>
    ...
    <title>Formulário de Investimento - webytemusic.com</title>
    ...
    <script>
        const valorDeMercado = 800000.00; // Valor fixo de mercado do Vendi Aqui
...
<body>
    <header style="text-align: center; margin-bottom: 0;">
        ...
        <p><strong>Valor de Mercado da Webyte Music: R$ 800.000,00 💰 (Previsão para 2025 📅, com grande potencial de crescimento à medida que a empresa se expande no mercado musical 🚀)

A Webyte Music está em uma trajetória de crescimento acelerado, com um valor estimado para 2025 de R$ 800.000,00. Este valor reflete a confiança no nosso modelo de negócios inovador e nas oportunidades de expansão no setor musical, um mercado que continua a se expandir de maneira impressionante.

Com a demanda crescente por novas plataformas e soluções no mercado musical, além dos nossos planos de inovação contínua, o valuation da Webyte Music tem um grande potencial de crescimento substancial 📈 nos próximos anos, o que pode trazer retornos ainda maiores para investidores e parceiros estratégicos.

Estamos empolgados com o futuro e as oportunidades que o mercado oferece, e convidamos você a se juntar a nós nesta jornada emocionante! 🌟</strong></p>
    </header>
    ...
    <form action="formulario_investimento.php" method="POST" style="margin: 0 20px;">
        ...
        <button type="button" onclick="window.location.href='https://investidores.webytebr.com/webytemusic.php'" class="submit-button" style="background-color: #007bff; margin-top: 10px;">Voltar ao Webyte Music</button>
    </form>
